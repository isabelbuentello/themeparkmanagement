        ...
        <>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 10, marginBottom: 16 }}>
            <article style={{ padding: 12, borderRadius: 10, background: 'rgba(241, 245, 249, 0.9)' }}>
              ...
              <div style={{ marginTop: 4, fontWeight: 800, color: '#0f172a' }}>{reportData.mostMaintenancedRide?.ride_name || 'No data'}</div>
              <div style={{ marginTop: 3, color: '#475569' }}>{reportData.mostMaintenancedRide ? `${reportData.mostMaintenancedRide.maintenance_count} requests` : ''}</div>
            </article>
            <article style={{ padding: 12, borderRadius: 10, background: 'rgba(241, 245, 249, 0.9)' }}>
              <div style={{ fontSize: '0.78rem', textTransform: 'uppercase', color: '#64748b', fontWeight: 700 }}>Total Maintenance Requests</div>
              <div style={{ marginTop: 4, fontWeight: 800, color: '#0f172a' }}>{reportData.summary.total_maintenance || 0}</div>
            </article>
            <article style={{ padding: 12, borderRadius: 10, background: 'rgba(241, 245, 249, 0.9)' }}>
              <div style={{ fontSize: '0.78rem', textTransform: 'uppercase', color: '#64748b', fontWeight: 700 }}>Average Resolution Time</div>
              <div style={{ marginTop: 4, fontWeight: 800, color: '#0f172a' }}>{formatMinutes(reportData.summary.avg_resolution_minutes)}</div>
            </article>
            <article style={{ padding: 12, borderRadius: 10, background: 'rgba(241, 245, 249, 0.9)' }}>
              <div style={{ fontSize: '0.78rem', textTransform: 'uppercase', color: '#64748b', fontWeight: 700 }}>Total Spent</div>
              <div style={{ marginTop: 4, fontWeight: 800, color: '#0f172a' }}>${Number(reportData.summary.total_spent || 0).toFixed(2)}</div>
            </article>
          </div>
            ...
            <table className="gm-table">
              ...
              <tbody>
                ...
                {reportData.frequencyByRide.length === 0 && (
                  <tr><td colSpan="4" style={{ textAlign: 'center' }}>No maintenance frequency data</td></tr>
                )}
              </tbody>
            </table>
          </div>
            ...
            <table className="gm-table">
              ...
              <tbody>
                ...
                {reportData.frequencyByDay.length === 0 && (
                  <tr><td colSpan="3" style={{ textAlign: 'center' }}>No maintenance date data</td></tr>
                )}
              </tbody>
            </table>
          </div>
            ...
            <table className="gm-table">
              ...
              <tbody>
                ...
                {reportData.records.length === 0 && (
                  <tr><td colSpan="10" style={{ textAlign: 'center' }}>No maintenance records found</td></tr>
                )}
              </tbody>
            </table>
          </div>
